                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <a type="button" onclick="addModal('{{route('position.add')}}')" class="btn btn-app">
    ...
    <div class="modal fade" id="modal-add">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form class="form-horizontal" method="post" action="{{ route('position.store') }}" id="form-add">
    ...
    <div class="modal fade" id="modal-edit">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form class="form-horizontal" method="post" action="{{ route('position.update') }}" id="form-edit">
                    <div class="modal-body">
    ...
    <div class="modal fade" id="modal-delete">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form class="form-horizontal" method="post" action="{{ route('position.destroy') }}" id="form-delete">
                    <div class="modal-body">
        ...
        $(function() {
            ...
            var table = $('.data-tables').DataTable({
                ...
                columns: [
                    ...
                    {data: 'c_position_abbr', name: 'c_position_abbr', "className": "text-center"},
                    {data: 'c_position_name', name: 'c_position_name', "className": "text-center"},
