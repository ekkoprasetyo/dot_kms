                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <a type="button" onclick="addModal('{{ route('knowledge-base.add') }}')" class="btn btn-app">
...
<div class="modal fade" id="modal-add">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <form class="form-horizontal" method="post" action="{{ route('knowledge-base.store') }}" id="form-add">
...
<div class="modal fade" id="modal-edit">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <form class="form-horizontal" method="post" action="{{ route('knowledge-base.update') }}" id="form-edit">
                <div class="modal-body">
...
<div class="modal fade" id="modal-delete">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form class="form-horizontal" method="post" action="{{ route('knowledge-base.destroy') }}" id="form-delete">
                <div class="modal-body">
...
<script type="text/javascript">
    ...
    $(function() {
        var table = $('.data-tables').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '{{ route('knowledge-base.datatables') }}',
                method: 'POST'
            },
            columns: [
                {data: 'DT_RowIndex', name: 'DT_RowIndex', "className": "text-center"},
                {data: 'c_knowledge_base_tags', name: 'c_knowledge_base_tags', "className": "text-center"},
                {data: 'c_knowledge_base_title', name: 'c_knowledge_base_title', "className": "text-center"},
                {data: 'c_users_fullname', name: 'c_users_fullname', "className": "text-center"},
                {data: 'c_knowledge_base_update_time', name: 'c_knowledge_base_update_time', "className": "text-center"},
