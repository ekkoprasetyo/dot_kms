    ...
    <div class="modal fade" id="modal-add">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form class="form-horizontal" method="post" action="{{ route('permission.store') }}" id="form-add">
    ...
    <div class="modal fade" id="modal-edit">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form class="form-horizontal" method="post" action="{{ route('permission.update') }}" id="form-edit">
                    <div class="modal-body">
    ...
    <div class="modal fade" id="modal-delete">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form class="form-horizontal" method="post" action="{{ route('permission.destroy') }}" id="form-delete">
                    <div class="modal-body">
