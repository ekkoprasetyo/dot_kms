                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <a type="button" onclick="addModal('{{route('users.add')}}')" class="btn btn-app">
    ...
    <div class="modal fade" id="modal-add">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form class="form-horizontal" method="post" action="{{ route('users.store') }}" id="form-add">
                    <div class="modal-header">
    ...
    <div class="modal fade" id="modal-edit">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form class="form-horizontal" method="post" action="{{ route('users.update') }}" id="form-edit">
                    <div class="modal-body">
    ...
    <div class="modal fade" id="modal-edit-password">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form class="form-horizontal" method="post" action="{{ route('users.update-password') }}" id="form-edit-password">
                    <div class="modal-body">
    ...
    <div class="modal fade" id="modal-delete">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form class="form-horizontal" method="post" action="{{ route('users.destroy') }}" id="form-delete">
                    <div class="modal-body">
        ...
        $(function() {
            var table = $('.data-tables').DataTable({
                ...
                columns: [
                    ...
                    {data: 'c_users_nip', name: 'c_users_nip', "className": "text-center"},
                    {data: 'c_users_fullname', name: 'c_users_fullname', "className": "text-center"},
                    {data: 'c_users_email', name: 'c_users_email', "className": "text-center"},
                    {data: 'c_role_display', name: 'c_role_display', "className": "text-center"},
                    {data: 'c_users_status', name: 'c_users_status', "className": "text-center"},
