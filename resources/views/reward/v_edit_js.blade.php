...
<div class="card-body">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input type="text" class="form-control is-warning" value="{{ $train->c_train_number }}" name="txt_train_number">
        </div>
    </div>
    <div class="form-group row">
        <label class="col-sm-3 col-form-label">Train Name</label>
        <div class="col-sm-9">
            <input type="text" class="form-control" value="{{ $train->c_train_name }}" name="txt_train_name">
        </div>
    </div>
</div>