...
{{--        </div>--}}
    ...
    <div class="card-body">
        ...
        <p>Kaki keseleo sebaiknya diberikan penangan apa ? </p>
    ...
    <div class="card-footer card-comments">
        ...
        <div class="card-comment">
            <!-- User image -->
            <img class="img-circle img-sm" src="{{ URL::asset('theme/adminlte305/dist/img/user4-128x128.jpg ') }}" alt="User Image">
